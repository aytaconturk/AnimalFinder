...
public class Level4Activity extends AppCompatActivity {
    ...
    public void start(){
        ...
        if(random == 0){
            ...
            im_2.setBackgroundResource(images[randomImg2]);
            im_3.setBackgroundResource(images[randomImg5]);
            im_4.setBackgroundResource(images[randomImg3]);
            ...
            im_3.setBackgroundResource(images[randomImg1]);
            im_4.setBackgroundResource(images[randomImg4]);
            im_5.setBackgroundResource(images[randomImg3]);
            im_6.setBackgroundResource(images[randomImg6]);
    ...
    private void nextLevel(){
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent nextLevel = new Intent(Level4Activity.this, Level4Activity.class);
